...
class CustomButton extends StatelessWidget {
  ...
  const CustomButton({
    ...
    this.borderRadius,
    this.backgroundColor = AppColors.color2,
    this.borderColor,
    this.textStyle,
    this.icon,
    this.padding
  ...
  Widget build(BuildContext context) {
    ...
    final Color effectiveBgColor = isDisabled
        ...
        : backgroundColor ?? (isDark ? AppColors.black : Color(0xFF85CE5C));
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: borderRadius ?? BorderRadius.circular(Dimensions.radius5),
