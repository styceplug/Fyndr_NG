class AppConstants {
  ...
  static const String REGISTER_NEW_BUSINESS =
      '/api/v1/user/register/new-vendor';
  ...
  static String MARK_JOB_AS_COMPLETED(String jobId) =>
      '/api/v1/job/$jobId/complete';
  ...
  static String COUNTER_QUOTE(String quoteId) =>
      '/api/v1/quote/$quoteId/counter';

  static String DECLINE_QUOTE(String quoteId) =>
      '/api/v1/quote/$quoteId/reject';
